...
| Multi-Hop | 31% | 75% | 51% |
| Temporal | 25% | 92% | 55% |
| Open-Domain | 39% | 91% | 73% |
| **命中率** | **14%** | 90% | 67% |

> 💡 LoCoMo 差距来自 FTS5 关键词检索→需语义搜索。LLM画像(1682字)比离线画像(63字)提升14个百分点。运行 `python locomo_benchmark.py` 复现。
