...
**基准测试（5万条 · 贾斯汀·比伯 14年数据）：**

| 测试 | 结果 |
|------|------|
| 精准检索 "Never say never" | Top3 命中 3/3 ✅ |
| 精准检索 "sorry" | Top3 命中 3/3 ✅ |
| 精准检索 "married" | Top3 命中 3/3 ✅ |
| 精准检索 "mental health" | Top3 命中 3/3 ✅ |
| FTS5高频词 "I want" | 2852条 → 16ms |
| 年份过滤 "I want" 2022 | 0条 → 11ms |
| 完整搜索链 | 10条 → 264ms |
