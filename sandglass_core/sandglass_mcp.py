"""NexSandglass MCP Server V2.6.14 =============================== 标准 MCP 协议——任何 MCP 兼容 Agent 可直接调用。 启动: python sandglass_mcp.py"""
        ...
        try:
            ...
            if method == "tools/list":
                tools = [
                    ...
                    {"name": "sandglass_search", "description": "关键词搜索记忆", "inputSchema": {"type": "object", "properties": {"query": {"type": "string", "description": "搜索关键词"}, "limit": {"type": "integer", "description": "返回条数", "default": 10}}}},
                    {"name": "sandglass_semantic", "description": "语义搜索记忆(同义词+SimHash+TF-IDF)", "inputSchema": {"type": "object", "properties": {"query": {"type": "string", "description": "搜索关键词"}, "limit": {"type": "integer", "description": "返回条数", "default": 5}}}},
                    {"name": "sandglass_recent", "description": "最近N条记忆", "inputSchema": {"type": "object", "properties": {"limit": {"type": "integer", "description": "返回条数", "default": 10}}}},
                    ...
                    {"name": "sandglass_dream", "description": "幽灵决策——'如果选另一个选项会怎样'", "inputSchema": {"type": "object", "properties": {"question": {"type": "string", "description": "假设问题", "default": "如果选另一个选项"}}}},
                    {"name": "sandglass_chart", "description": "情绪熵 ASCII 可视化图表", "inputSchema": {"type": "object", "properties": {"n": {"type": "integer", "description": "最近N条消息", "default": 10}}}},
                    {"name": "sandglass_migrate", "description": "一键导出全部记忆数据为 tar.gz", "inputSchema": {"type": "object", "properties": {"output": {"type": "string", "description": "输出路径", "default": ""}}}},
                    {"name": "sandglass_soul_export", "description": "导出灵魂差分(偏移率+决策+回音折)", "inputSchema": {"type": "object", "properties": {"output": {"type": "string", "description": "输出路径", "default": ""}}}},
                    {"name": "sandglass_soul_merge", "description": "合并外部灵魂差分", "inputSchema": {"type": "object", "properties": {"source": {"type": "string", "description": "灵魂差分文件路径"}}}},
                    {"name": "sandglass_import", "description": "导入外部沙漏或ChatGPT/Claude对话导出", "inputSchema": {"type": "object", "properties": {"source_path": {"type": "string", "description": "源文件路径"}, "format": {"type": "string", "description": "格式: sandglass/chatgpt/claude", "default": "sandglass"}}}},
                    {"name": "sandglass_export", "description": "导出沙漏为可迁移文件", "inputSchema": {"type": "object", "properties": {"output_path": {"type": "string", "description": "输出路径"}, "limit": {"type": "integer", "description": "导出条数"}, "month": {"type": "string", "description": "指定月份 YYYY-MM"}}}},
                    {"name": "sandglass_thread", "description": "查询织线知识图谱——实体关系三元组", "inputSchema": {"type": "object", "properties": {"entity": {"type": "string", "description": "实体名称"}, "relation": {"type": "string", "description": "关系过滤"}, "limit": {"type": "integer", "description": "返回条数", "default": 20}}}},
                    {"name": "sandglass_thread_graph", "description": "织线实体子图——展开N跳关系", "inputSchema": {"type": "object", "properties": {"entity": {"type": "string", "description": "实体名称"}, "depth": {"type": "integer", "description": "展开深度", "default": 1}}}},
                    {"name": "sandglass_thread_weave", "description": "织线→织布机桥接——因果链摘要", "inputSchema": {"type": "object", "properties": {"limit": {"type": "integer", "description": "摘要条数", "default": 3}}}},
                    {"name": "sandglass_thread_add", "description": "手动补入三元组——Agent发现漏抓时调用", "inputSchema": {"type": "object", "properties": {"subject": {"type": "string", "description": "主体", "default": "user"}, "relation": {"type": "string", "description": "关系"}, "object": {"type": "string", "description": "客体"}}}},
                ]
