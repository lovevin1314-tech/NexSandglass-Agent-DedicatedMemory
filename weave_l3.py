...
try:
    from sandglass_think import _fail_open, _llm, comprehensive_offset
except:
...
def weave_contradiction() -> dict:
    ...
    ), "interlinks": weave_links() if __import__('sandglass_think').stage_list() and len(__import__('sandglass_think').stage_list()) >= 2 else {"linked": False}}
